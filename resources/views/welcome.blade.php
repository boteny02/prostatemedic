        ...
        <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
            ...
            <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <header class="grid items-center gap-2 py-12 lg:grid-cols-12">
                        <div class="flex lg:justify-center lg:col-start-2">
                            <nav class=" flex flex-1 justify">
                                <a href="#" class="text-xl font-medium text-black dark:text-white/70">Welcome to Data Collection App for research Development of Prostate Cancer Predictive system Using Multi-Modal Data and Ensemble Learning Techniques</a>
                                
                                
                                <a
                                href="admin/login"
                                class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white" style="background-color: #FF2D20; color: white; padding: 10px; border-radius: 5px; margin-left: 10px;"
                            >
                                Login
                        ...
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                ...
                                <div class="relative flex items-center gap-6 lg:items-end">
                                    <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                        ...
                                        <div class="pt-3 sm:pt-5 lg:pt-0">
                                            <h2 class="text-xl font-semibold text-black dark:text-white">Research </h2>

                                            <p class="mt-4 text-sm/relaxed">
                                                Researcher Mobolaji Olufemi Tenibiaje is a software engineer and data scientist with a passion for using technology to solve real-world problems.
                                                Multi-modal Prostate Cancer Prediction system is a web-based application that allows users to input their data, and view the results in a clean and easy-to-understand format.
                                                Development of Prostate Cancer Predictive system Using Multi-Modal Data and Ensemble Learning Techniques
                            ...
                            >
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">PSA, DRE and Ultrasound Data</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                       A simple Tool to collect data for the research of prostate cancer. 
                                       This tool allows users to input their data, and view the results in a clean and easy-to-understand format.
                                    </p>
                                </div>
                            ...
                            >
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">Why the data collection tool</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                       The research is performed using Multimodal data and ensemble techniques. The data collection tool is used to collect data for the research of prostate cancer.
                                    </p>
                                </div>
                            ...
                            <div class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">Filament / Laravel</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        Laravel and filament are part of a vibrant ecosystem of this  tools and libraries that work together to help delieve this Web App. 
